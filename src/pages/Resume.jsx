      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ margintop: 10, fontSize: 15, color: "#ccc" }}>
              4th Year B.E — Computer Engineering | Government College of Engineering & Research, Avasari Khurd
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              📍 Pune, Maharashtra, India
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              ✉️ onkarbansode77@gmail.com | 📞 +91 8956446484
            </p>
          </div>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            <li>
              <strong>B.E Computer Engineering</strong> — Government College of Engineering & Research, Avasari Khurd
              (SPPU University), 2023–2026 <br />
              <span style={{ color: "#aaa" }}>GPA: 9.50</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>Diploma Computer Science</strong> — Government Polytechnic Solapur (MSBTE
              Board), 2020-2023 <br />
              <span style={{ color: "#aaa" }}>Percentage: 90.46%</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>10th Board — Vidya Mandir Highschool</strong> (SSC Board, 2020)
              <br />
              <span style={{ color: "#aaa" }}>Percentage: 92.80%</span>
            </li>
          </ul>
        </motion.div>
