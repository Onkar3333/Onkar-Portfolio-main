...
export default function Home() {
  ...
  const quickLinks = [
    ...
    { img: facebookLogo, title: 'Facebook', link: 'https://www.facebook.com/onkar.bansode' },
  ]

  const [text, setText] = useState('')
  const [isDeleting, setIsDeleting] = useState(false)
  const fullText = "Artificial Intelligence Engineer | Frontend Developer | Tech Explorer"
        ...
        >
          ...
          <motion.div className="info-cards">
            {[
              ...
              { label: '📧 Contact', value: 'onkarbansode77@gmail.com' },
            ].map((info, i) => (
