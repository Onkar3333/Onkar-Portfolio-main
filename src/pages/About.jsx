          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Government College of Engineering & Research, Avasari Khurd</strong> — (SPPU University)
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  4th Year (Pursuing) | GPA: 9.50
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Government Polytechnic Solapur</strong> — (MSBTE Board)
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Percentage: 90.46%
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Vidya Mandir Highschool</strong> — (SSC Board)
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Percentage: 92.80%
                </p>
